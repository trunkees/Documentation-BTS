<?php
    // Assurez-vous que $ProjetNom est défini avant de l'utiliser
    $ProjetNom = isset($ProjetNom) ? $ProjetNom : "";
    $valeur_a_copier_projet = "skillmate.com/" . urlencode($ProjetNom);
?>

<input type="text" value="<?php echo $valeur_a_copier_projet; ?>" id="valeurProjet" style="display: none;" readonly>
<div onclick="copierDansPressePapiersProjet()" style="cursor: pointer; width: 25px; height: 25px;">
...
<script>
    function copierDansPressePapiersProjet() {
        var champDeTexte = document.getElementById("valeurProjet");
